# Cadastro Inteligente — Flask + SQLite (Pronto para Codespace)
...
## Rodando no Codespace (passo a passo)
1. Faça upload do conteúdo deste repositório ou extraia o ZIP em um workspace do Codespace.
